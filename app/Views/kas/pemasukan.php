                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.success && res.html) {
                            ...
                            //     res.newData.tanggal,
                            //     res.newData.user_id,
                            //     '<button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal' + res.newData.kode_kas + '">Edit</button> <a href="/kas/pemasukan/delete/' + res.newData.kode_kas + '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>'
                            // ]).draw(false);
                            // Lalu kosongkan form: $('#form-tambah-kas')[0].reset();
